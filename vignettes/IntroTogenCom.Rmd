...
```{r, message=FALSE, warning=FALSE}
mirrorplot::gencom_format(assoc_data = mark3_bmd_gwas, chr_col = 3, pos_col = 4, p_col = 11)
```
...
```{r}
mirrorplot::gencom_ld(assoc_data = mark3_bmd_gwas_f, rs_col = 2, pops = "EUR", lead_snp = "rs11623869")
```
